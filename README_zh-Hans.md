...
/src目录包含了LibDriver GT30L32S4W的源文件。

/interface目录包含了LibDriver GT30L32S4W与平台无关的SPI总线模板。

/test目录包含了LibDriver GT30L32S4W驱动测试程序，该程序可以简单的测试芯片必要功能。

/example目录包含了LibDriver GT30L32S4W编程范例。

/doc目录包含了LibDriver GT30L32S4W离线文档。

/datasheet目录包含了GT30L32S4W数据手册。
...
在线文档: [https://www.libdriver.com/docs/gt30l32s4w/index.html](https://www.libdriver.com/docs/gt30l32s4w/index.html)。
